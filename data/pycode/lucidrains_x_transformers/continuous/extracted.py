...
# --- Block 1: GaussianNLL (class) ---
# From: x_transformers/continuous.py:55
# Category: other
...
# --- Block 2: ContinuousTransformerWrapper (class) ---
# From: x_transformers/continuous.py:62
...
# --- Block 3: ContinuousAutoregressiveWrapper (class) ---
# From: x_transformers/continuous.py:239
# Category: other
