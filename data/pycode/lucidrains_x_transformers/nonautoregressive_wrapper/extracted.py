...
# --- Block 1: SelfCritic (class) ---
# From: x_transformers/nonautoregressive_wrapper.py:87
# Category: other
...
# --- Block 2: NonAutoregressiveWrapper (class) ---
# From: x_transformers/nonautoregressive_wrapper.py:99
# Category: other
